 ...
 * application. It's also used in other parts of the application that
 * identify the name of this application.  To access this in your the
 * application use the following code:
 *
 *  	$this->config->item("app_name");
 */
$config['app_name'] = "myCMS";
